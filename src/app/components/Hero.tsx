                ...
                <div>
                    ...
                    <ul className="mt-6 grid gap-2 text-sm text-neutral-700">
                        {['Supplies included', 'Insured & background‑checked', 'Satisfaction guarantee'].map(t => (
                            <li className="flex items-center gap-2" key={t}><CheckCircle2 className="h-4 w-4 text-brand-700" /> {t}</li>
                        ))}
                    </ul>
                </div>
                <div className="relative">
                    <img src="/hero.jpg" alt="Spotless kitchen" className="rounded-2xl shadow-soft border border-neutral-100" />
                    <div className="absolute -bottom-6 -left-6 bg-white border border-neutral-100 shadow-soft rounded-2xl p-4">
                        <p className="text-sm"><span className="font-semibold">450+ cleans</span> this year • 4.9/5 rating</p>
                    </div>
                </div>
            </div>
        </section>
